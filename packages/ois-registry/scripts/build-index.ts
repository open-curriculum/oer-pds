...
const validationRules = loadYamlDir<ValidationRule>(join(dataDir, "validation-rules"));
...
console.log(`Written: dist/ois-index.json (${tokens.length} tokens, ${patterns.length} patterns, ${themes.length} themes)`);
